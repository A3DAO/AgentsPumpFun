...
import com.agent.common.util.Requires;
...
public class ThreadPoolUtil {
     ...
     * @param coreThreads      the number of threads to keep in the pool, even if they are idle, unless
    ...
    public static ThreadPoolExecutor newThreadPool(final String poolName, final boolean enableMetric,
                                                   final int coreThreads, final int maximumThreads, final long keepAliveSeconds,
    ...
    public static ThreadPoolExecutor newThreadPool(final String poolName, final boolean enableMetric,
        ...
        return new LogThreadPoolExecutor(coreThreads, maximumThreads, keepAliveSeconds, unit, workQueue, threadFactory,
                rejectedHandler, poolName);
    }
    ...
    public static ScheduledThreadPoolExecutor newScheduledThreadPool(final String poolName, final boolean enableMetric,
                                                                     final int coreThreads, final ThreadFactory threadFactory) {
     ...
     */
    public static ScheduledThreadPoolExecutor newScheduledThreadPool(final String poolName, final boolean enableMetric,
                                                                     final int coreThreads, final ThreadFactory threadFactory, final RejectedExecutionHandler rejectedHandler) {
